...
const coursesData = [

    {
        ...
        description:
            "From quartz sand to a finished chip: purification, crystal growth, the cleanroom, the layer-building tools, lithography, doping, the CMOS process flow, yield, packaging, and the industry that builds it.",
        icon: "🏭",
        status: "live",
        growing: false,
